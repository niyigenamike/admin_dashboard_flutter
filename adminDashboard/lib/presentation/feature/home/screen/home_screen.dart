...
class _HomeScreenState extends ConsumerState<HomeScreen> {
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  // add24VerticalSpace(),
                  /*  getMenuItem(
                      AppTexts.menuHome, selectedMenu == DashboardMenu.home,
                      () {
                    menuSelectionNotifier.selectMenu(DashboardMenu.home);
                  }),*/
                  //  add8VerticalSpace(),
                  getMenuItem(AppTexts.menuAllPost,
                      selectedMenu == DashboardMenu.allPost, () {
  ...
  Widget getAddPostItem(bool isSuperAdmin, DashboardMenu selectedMenu) {
    if (isSuperAdmin) {
      return getMenuItem(
          AppTexts.menuAddPost, selectedMenu == DashboardMenu.addPost, () {
  ...
  Widget getWidgetByMenuSelection(DashboardMenu menu) {
    switch (menu) {
      ...
      case DashboardMenu.addPost:
        return Container(
          padding:
              const EdgeInsets.only(top: 56, bottom: 56, left: 56, right: 56),
